...
The LSTM learns to correct Prophet's baseline forecast by predicting
the residual (actual - Prophet prediction), especially around surge events
where Prophet alone tends to under-predict.
"""
