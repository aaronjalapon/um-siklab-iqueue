...
export const uiStyles = {
  ...
  elevatedSurface:
    "rounded-xl border border-ui-border bg-ui-surface text-ui-foreground shadow-[0_1px_2px_rgba(11,31,51,0.08)] dark:shadow-none",
  button:
  ...
  primaryButton:
    "inline-flex min-h-11 cursor-pointer items-center justify-center gap-2 rounded-lg border border-ui-primary bg-ui-primary px-4 py-2 font-semibold text-white transition-colors duration-150 hover:bg-ui-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ui-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-45 dark:text-ui-navy",
  secondaryButton:
  ...
  input:
    "block min-h-11 w-full rounded-lg border border-ui-border bg-ui-surface px-3 py-2.5 text-ui-foreground outline-none transition-colors duration-150 placeholder:text-ui-muted-foreground focus:border-ui-primary focus:ring-2 focus:ring-ui-primary/20 disabled:cursor-not-allowed disabled:bg-ui-muted disabled:text-ui-muted-foreground",
  statCard:
    "flex items-center gap-4 rounded-xl border border-ui-border bg-ui-surface p-5 text-ui-foreground shadow-[0_1px_2px_rgba(11,31,51,0.05)] dark:shadow-none",
  sectionTitle: "font-heading text-lg font-semibold text-ui-foreground",
  badge:
    "inline-flex items-center gap-1 rounded-full border border-ui-border bg-ui-muted px-2.5 py-1 text-xs font-semibold text-ui-muted-foreground",
